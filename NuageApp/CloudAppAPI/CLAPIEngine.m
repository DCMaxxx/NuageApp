...
- (NSString *)changePrivacyOfAccount:(CLAccount *)account userInfo:(id)userInfo {
	...
	NSData *bodyData = [CLAPISerializer settingForGlobalPrivacy:![account uploadsArePrivate]];
	if (bodyData == nil)
		return nil;
...
- (NSString *)changeToEmail:(NSString *)newEmail withPassword:(NSString *)password userInfo:(id)userInfo {
    if (![self isReady] || newEmail == nil || password == nil)
		return nil;
	...
	NSData *bodyData = [CLAPISerializer changeToEmail:newEmail withPassword:password];
	if (bodyData == nil)
		return nil;
...
- (NSString *)changeToPassword:(NSString *)newPassword withCurrentPassword:(NSString *)password userInfo:(id)userInfo {
    if (![self isReady] || newPassword == nil || password == nil)
		return nil;
	...
	NSData *bodyData = [CLAPISerializer changeToPassword:newPassword withCurrentPassword:password];
	if (bodyData == nil)
		return nil;
...
- (NSString *)updateCustomDomain:(NSString *)customDomain customDomainHome:(NSString *)customDomainHome userInfo:(id)userInfo {
    if (![self isReady] || customDomain == nil)
		return nil;
	...
	NSData *bodyData = [CLAPISerializer updateCustomDomain:customDomain customDomainHome:customDomainHome];
	if (bodyData == nil)
		return nil;
